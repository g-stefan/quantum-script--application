...
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-application.static.compile
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-application.dynamic.compile
