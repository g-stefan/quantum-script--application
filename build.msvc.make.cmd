...
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-application.static.compile.info
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-application.dynamic.compile.info
