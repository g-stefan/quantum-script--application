...
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-application.static.compile
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-application.dynamic.compile
