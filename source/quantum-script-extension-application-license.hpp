...
#define QUANTUM_SCRIPT_EXTENSION_APPLICATION_LICENSE_HPP
	...
	namespace Script {
		namespace Extension {
			namespace Application {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_APPLICATION_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_APPLICATION_EXPORT const char *shortContent();
				};
			};
		};
	};
